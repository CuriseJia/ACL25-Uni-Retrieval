...
# model = blip_itm(pretrained='/public/home/jiayanhao/airproduct/BLIP/model_large_retrieval_coco.pth', image_size=224, vit='large', vit_grad_ckpt=True, vit_ckpt_layer=10)
model = blip_retrieval(pretrained='/public/home/jiayanhao/airproduct/BLIP/model_large_retrieval_coco.pth', image_size=224, vit='large', vit_grad_ckpt=True, vit_ckpt_layer=10)
model.eval()
model.to(device)
...
# pair = json.load(open('/public/home/jiayanhao/imagenet/200-original-long-val.json', 'r'))
# acc = []
...
#         ori_image.append(os.path.join('/public/home/jiayanhao/imagenet/val/', pair[index]['image_path']))
#         sketch_image.append(os.path.join('/public/home/jiayanhao/imagenet/imagenet-p/val/', pair[index]['image_path']))
